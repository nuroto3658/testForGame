class AppFacade extends puremvc.Facade implements puremvc.IFacade
{
    ...
    public initializeController(): void
    {
        ...
        this.registerCommand(app.AppMsgConst.STARTUP, AppStartupCommand);
    }
    ...
    {
        this.sendNotification(app.AppMsgConst.STARTUP, main);
        this.removeCommand(app.AppMsgConst.STARTUP); //PureMVC初始化完成，注销STARUP命令
    }
}
